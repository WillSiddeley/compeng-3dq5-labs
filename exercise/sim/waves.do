...
add wave -divider -height 20 {LED Lights}
add wave -hex UUT/LED_GREEN_O
add wave -hex UUT/LED_RED_O
...
add wave -divider -height 20 {Misc}
add wave -hex UUT/upper_case
add wave -hex UUT/state